...
const TRoom = (props) => {
  ...
  return (
    <group position={props.position} >
      {/* left */}
      <Item draggable={false} tag={"wall"} whitelist={{ left: ['none'], right: ['none'], top: ['none'] }} blacklist={{ left: [], right: [], top: [] }} objectList={props.objectList} pointerPosition={props.pointerPosition} grab={props.grab} nanoid={useRef(nanoid()).current}>
      ...
      <Item draggable={false} tag={"wallpaper"} whitelist={{ left: ['none'], right: ['none'], top: ['none'] }} blacklist={{ left: [], right: [], top: [] }} objectList={props.objectList} pointerPosition={props.pointerPosition} grab={props.grab} nanoid={useRef(nanoid()).current}>
      ...
      <Item draggable={false} tag={"wallpaper"} whitelist={{ left: ['none'], right: ['none'], top: [] }} blacklist={{ left: [], right: [], top: [] }} objectList={props.objectList} pointerPosition={props.pointerPosition} grab={props.grab} nanoid={useRef(nanoid()).current}>
