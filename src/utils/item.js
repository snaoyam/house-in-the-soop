        ...
        onPointerMove={(e) => {
          if (this.grabbing) {
            ...
            const leftCloseSpaces = [{ x: objectBoundingBox.min.x, y: objectBoundingBox.min.y }, { x: objectBoundingBox.max.x, y: objectBoundingBox.min.y }, { x: objectBoundingBox.min.x, y: objectBoundingBox.max.y }, { x: objectBoundingBox.max.x, y: objectBoundingBox.max.y }]
              ...
              .map((v) => {
                return [v.at(0), v.at(1).max.z, v.at(2).reduce((a, c) => {
                  return { 
            ...
            const leftClosestSpace = leftCloseSpaces.reduce((a, c) => {
              const distance = Math.min(
                (c.at(1).minX - objectBoundingBox.min.x) * (c.at(1).minX - objectBoundingBox.min.x) + (c.at(1).minY - objectBoundingBox.min.y) * (c.at(1).minY - objectBoundingBox.min.y),
                (c.at(1).maxX - objectBoundingBox.max.x) * (c.at(1).maxX - objectBoundingBox.max.x) + (c.at(1).minY - objectBoundingBox.min.y) * (c.at(1).minY - objectBoundingBox.min.y),
                (c.at(1).minX - objectBoundingBox.min.x) * (c.at(1).minX - objectBoundingBox.min.x) + (c.at(1).maxY - objectBoundingBox.max.y) * (c.at(1).maxY - objectBoundingBox.max.y),
                (c.at(1).maxX - objectBoundingBox.max.x) * (c.at(1).maxX - objectBoundingBox.max.x) + (c.at(1).maxY - objectBoundingBox.max.y) * (c.at(1).maxY - objectBoundingBox.max.y)
              ) + (c.at(0) - objectBoundingBox.min.z) * (c.at(0) - objectBoundingBox.min.z)
